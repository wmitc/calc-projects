 ...
 */
int64_t evaluate_signed_equation(
    int64_t num1, int8_t operation, int64_t num2, int64_t *result, int8_t *type)
{

    // Create error parameter to track whether solving equation was
    // successful/unsuccesful, result will be recorded via a set bit when
